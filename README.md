...
Ahora bien, cuándo entendemos esto, también podemos comprender que así cómo el individuo genera datos, ***requiere de una relación  con estos sistemas informáticos para volcar cualquier dato que se necesite con el fin de cumplir diferenciados objetivos***. También podemos entender que el usuario tiene contanto con estos sistemas a través de su **interfaz**. Por lo tanto, ***HTML** proporciona diferentes elementos para cumplir estos objetivos en los sistemas web*. Estos elementos son los **formularios** y sus **controles o widgets**
